...
export const metadata: Metadata = {
  title: "TERMS OF USE - help center",
  description:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="lg:col-span-3">
          <article className="prose prose-lg max-w-none">
            ...
            <section className="mb-12 scroll-mt-8">
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Thank you for visiting FincBloc.com. By visiting, accessing or
                  using FincBloc.com and associated mobile applications
                  downloaded from the Apple App Store or the Google Play Store
                  (“FincBloc Platform”, “FincBloc”), you (“User”, “You”) agree
                  that you have read, understood and accepted and consented to
                  the Terms of Use (the “Terms”) set out below. The services on
                  the FincBloc Platform are provided by BuildLight Future
                  Limited.
                </p>
              </div>
            </section>
            ...
            <ul>
              <li className="list-disc text-gray-700 mb-1.5">
                The digital currencies themselves are not offered by any
                financial institution, corporation and/or FincBloc.
              </li>
              ...
              <li className="list-disc text-gray-700 mb-1.5">
                ...
                Risk Warning can be found at
                https://fincbloc.com/en/risk-warning.
              </li>

              <li className="list-disc text-gray-700 mb-1.5">
                You shall assume all risks related to the use of FincBloc
                Services (defined at clause 9.1 below) and transactions of
                digital currencies and their derivatives.
              </li>

              <li className="list-disc text-gray-700 mb-1.5">
                FincBloc shall not be liable for any such risks or adverse
                outcomes.
              </li>

              <li className="list-disc text-gray-700 mb-1.5">
                FincBloc is not your broker, intermediary, agent, or advisor and
                has no fiduciary relation or obligation to you in connection
                with any trades and/or transactions and/or other decisions or
                activities effected by you when using the FincBloc Services. No
                communication or information provided to you by FincBloc is
              ...
              <li className="list-disc text-gray-700 mb-1.5">
                Unless otherwise specified in these Terms, all trades are
                ...
                objectives and agree that you are solely responsible for any
                loss or liability therefrom. You should consult legal and tax
                professionals regarding your specific situation. FincBloc does
                not recommend digital assets should be bought, earned, sold or
                held by you. Before making the decision to buy, sell or hold any
                digital asset, you should conduct your own due diligence.
                FincBloc will not be held responsible for the decisions you make
                to buy, sell, or hold digital assets based on the information
                provided by FincBloc.
              </li>
            </ul>
            <div className="mt-4">
              ...
              {/* intro */}
              <h2 className="text-gray-700 text-[20px]">2. INTRODUCTION</h2>
              <ol className="list-decimal mt-2 pl-8 text-gray-700">
                <li>
                ...
                <li>
                  ...
                  event of any ambiguity, discrepancy or omission as between the
                  English text and any translated text.
                </li>
                <li>
                  You agree that any official communications with you will,
              ...
              {/* Eligibility */}
              <h2 className="text-gray-700 text-[20px]">4. ELIGIBILITY</h2>
              <ol className="list-decimal mt-2 pl-8 text-gray-700">
                <li>
              ...
              <ol className="list-decimal mt-2 pl-8 text-gray-700">
                ...
                <li>
                  ...
                  limited to, fraud and money laundering. The information we
                  require to verify your identity may include, but is not
                  limited to your name, email address, contact information,
                  phone number, username, government-issued ID, date of birth
                  and other information (as required) during account
                  registration.
                </li>
                <li>
                  When providing the required information, you confirm that you
