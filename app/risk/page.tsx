...
export default function FincBlocRisk() {
  return (
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <section className="mb-12 scroll-mt-8">
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  This Risk Disclosure Statement (hereinafter as 'Statement')
                  aims to reveal to investors the investment risks of digital
                  asset derivatives products and to help investors assess and
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-700">
                Derivatives transactions for digital assets are highly leveraged
                and bear substantial risk. As such, it is only suitable for
                professional investment institutions, experienced investors, or
                those who fully understand the risk related to derivatives
                transactions of digital assets. Most importantly, derivatives
                transactions of digital assets are only suitable for those who
                can assume responsibility for loss of funds due to any
              ...
              <p className="text-gray-700">
                BY INVESTING IN OR OTHERWISE PARTAKING IN THE TRADING OF DIGITAL
                ASSETS AND/OR THEIR DERIVATIVES, YOU RISK LOSSING THE ENTIRETY
                OF YOUR ASSETS/FUNDS/POSITIONS WITHOUT ANY POSSIBILITY OF
              ...
              <p className="text-gray-700">
                As a special product with investment value, the price of digital
                currency derivatives is affected by many factors, and the price
                fluctuates greatly as a result. It is difficult for any investor
                to fully acknowledge or respond to the effect of these variables
                in real-time, so there is the possibility of poorly-made
                investment decisions. As risk cannot be effectively controlled,
                investors may suffer great losses and should bear all
                responsibility for any loss that occurs.
              </p>
              ...
              <p className="text-gray-700">
                Investors should understand that derivatives trading is
                characterised by high leverage, which may lead to quick profits
                or losses. If the direction of the transaction is opposite to
                the fluctuation of the market, it will cause a larger loss.
                Investors may increase the digital currency margin or reduce
                their positions, to prevent the possibility of a liquidation. In
                either scenario, investors must bear all responsibility for any
                loss or liquidation/closout that occurs. In the exchange's
                trading system, the limit order submitted by the investor is
                irrevocable once the transaction is executed, and the investor
                must accept the risks that may be brought about by this
                mechanism. The exchange does not guarantee profit to its
                investors, nor does it bear the responsibility of profit or risk
                with investors
              </p>
              ...
              <p className="text-gray-700">
                ...
                times of rapid price movements, in which case you may suffer
                great financial losses to your funds.
              </p>
              ...
              <p className="text-gray-700">
                ...
                positions when you wish to do so.
              </p>
              ...
              <p className="text-gray-700">
                The risk factors mentioned in this Statement are not exhaustive,
                and all risk factors related to digital asset derivatives
                trading are not listed in detail. Before investing in digital
                asset derivatives trading, investors should also seriously
