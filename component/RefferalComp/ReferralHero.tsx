        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6 lg:space-y-8">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
              30% Commission. Invite Your Friends Now.
            </h1>

            <p className="text-gray-400 text-base sm:text-lg lg:text-xl max-w-2xl leading-relaxed">
              Welcome Bonus for friends, 30% for you. Make profits together now.
            </p>
            <Link href={"https://dash.fincbloc.com/login"}>
              <button className="bg-[#ff9900] hover:bg-zinc-700 text-black font-medium px-8 py-4 rounded-lg transition-colors duration-200 text-base sm:text-lg">
                Invite now
              </button>
            </Link>
          </div>
